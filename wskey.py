...
def get_sign():
    ...
    payload = {
        ...
        "functionId": "genToken",
        "version": "10.0.8",
        "body": '{"action":"to","to":"https%3A%2F%2Fplogin.m.jd.com%2Fcgi-bin%2Fm%2Fthirdapp_auth_page%3Ftoken%3DAAEAIEijIw6wxF2s3bNKF0bmGsI8xfw6hkQT6Ui2QVP7z1Xg%26client_type%3Dandroid%26appid%3D879%26appup_type%3D1"}'
    }
    payload = json.dumps(payload)
    for i in range(3):
        try:
